...
## Concept
Mon projet est un livre intéractif de style «Goosebump» où le lecteur devra faire des choix qui influencera le sort du héro de l'histoire.
...
## Structure du livre
### Entrées:
Les entrées sont les choix du lecteur. Le lecteur aura le choix entre 2 ou parfois 3 options pour continuer l'histoire.
